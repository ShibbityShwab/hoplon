...
- **Three isolation tiers.** `HOPLON_ISOLATION=host` (the default) keeps the isolated home on this machine; `vm` boots a Debian QEMU guest; `nix` boots a declarative NixOS guest. Both guests have their own kernel.
