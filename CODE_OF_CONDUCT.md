...
When an incident does occur, it is important to report it promptly. To report a possible violation, open a private security advisory through this repository's **Security** tab, using the **Report a vulnerability** button. That channel is private between you and the maintainers. If you cannot use GitHub advisories, open a public issue that asks for a private contact channel and do not include the details of the incident in the issue itself.
